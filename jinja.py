...
@app.route('/')
def welcome():
    return render_template('/jinja1.html')  # See in templates folder in same repo
...
def success(score):
    ...
    if score >= 5000:
        ...
        res = "LESS"
    return render_template('/jinja2.html', X=res)  # See in templates folder in same repo for html
